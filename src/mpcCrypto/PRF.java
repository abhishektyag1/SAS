...
public class PRF implements Serializable {
	...
	public PRF(int a_threshold, Channel[] channels) throws IOException {
		...
		//System.out.println("The key inside prf is " + PedersonComm.combineShares(key,channels));
		//System.out.println("The key added to itself is " + PedersonComm.combineShares(key.add(key),channels));
	...
	private void writeObject(java.io.ObjectOutputStream stream) throws IOException {
		System.out.println("File PRF method writeObject and The key, publickey, threshold are"+key+"----------- "+ publicKey.toBytes() + " --------------" + threshold);
